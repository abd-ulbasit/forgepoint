...
{{/*
fp-model-serving.validateJwtSecret — fail-closed validation for the shared HMAC-SHA256 key.
...
the validated key so call sites do `{{ include "fp-model-serving.validateJwtSecret" . | quote }}`.
*/}}
{{- define "fp-model-serving.validateJwtSecret" -}}
