...
{{/*
fp-inference-gateway.validateJwtSecret — fail-closed validation for the shared HMAC-SHA256 key.
...
the validated key so call sites do `{{ include "fp-inference-gateway.validateJwtSecret" . | quote }}`.
*/}}
{{- define "fp-inference-gateway.validateJwtSecret" -}}
