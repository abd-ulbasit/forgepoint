...
{{/*
fp-billing.validateJwtSecret — fail-closed validation for the shared HMAC-SHA256 key.
...
the validated key so call sites do `{{ include "fp-billing.validateJwtSecret" . | quote }}`.
*/}}
{{- define "fp-billing.validateJwtSecret" -}}
