...
// context.Context. Exported so auth interceptors in pkg/grpcutil can write
// claims into the context without importing the full domain package in a way
// that would create a circular dependency.
//
// Usage in an auth interceptor:
//
