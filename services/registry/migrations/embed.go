// Package migrations embeds the registry's SQL migration files so tests (and, if
// wanted, the binary) can read them without a filesystem path dependency.
//
// ============================================================================
...
// surprise — exactly the guarantee we want for schema that the adapter assumes exists.
//
//go:embed *.sql
var files embed.FS
